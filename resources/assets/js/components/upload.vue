...
export default {
    ...
    methods:{
            ...
            if(this.crop){
                ...
                fr.onload=e=>{
                    ...
                    this.img.onload=()=>{
                        ...
                        // 按原始图片比例优先使用小值设置最低值
                        if(this.img.naturalWidth*this.height>this.img.naturalHeight*this.width){
                ...
                this.files=[];
                this.getFiles(e);
                if (this.isAuto)this.uploadFiles()
            }
        },
        getFiles(e) {
            e.stopPropagation();
        ...
        cropGetRatio(){
            let iw = this.img.naturalWidth, ih = this.img.naturalHeight;
...
<div class="upload">
    ...
    <input type="file" class="upload" @change="fileChange" :accept="accepts" :multiple="isMultiple">
    <input type="hidden" :name="filename" v-model="file">
